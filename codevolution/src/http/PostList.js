...
//React does not have an http implementation, so in order to do http requests to the server we have to download a specific library like axios (npm install axios).Next we need to import the library and create a property that will store the lists of posts.
